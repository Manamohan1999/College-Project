...
<body class="grey lighten-3">
  ...
  <header>
    ...
    <div class="sidebar-fixed position-fixed aqua-gradient color-block">
      ...
      <a class="logo-wrapper waves-effect">
        <img src="images/logo22.png" alt="logo" class="img-fluid" > <p class="text-center font-weight-bold ">Staff Panel</p>
      </a>
  ...
  <div class="collapse" id="collapseExamplesidebar2">
   ...
   <a href="#collapseExamplesidebar4" class="list-group-item list-group-item-action waves-effect" data-toggle="collapse" aria-expanded="false" aria-controls="collapseExamplesidebar4">
   <i class="fas fa-user-graduate mr-3"></i>Internal Marks <i class="fas fa-angle-down rotate-icon ml-1"></i></a>
  <div class="collapse" id="collapseExamplesidebar4">
      <a href="#" class="list-group-item list-group-item-action waves-effect">
